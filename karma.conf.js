  ...
  config.set({
    ...
    // list of files / patterns to load in the browser
     files: [
      ...
      // './app/assets/javascripts/components/**/*.{js,es6}',
      // './app/assets/javascripts/filters/**/*.{js,es6}',
      // './app/assets/javascripts/directives/**/*.{js,es6}',
      // './app/assets/javascripts/services/**/*.{js,es6}',
      // './app/assets/javascripts/providers/**/*.{js,es6}',
      // './app/assets/javascripts/app.*.{js,es6}',
      './app/assets/javascripts/app.js',
      './test/assets/javascripts/**/*.spec.js',
      {
        pattern: 'public/dev-assets/*.js',
        watched: true,
        included: false,
        served: false
      }
