import newMemberForm from '../newMemberModal/_newMemberForm.html';
import createTeamFrom from '../CreateTeamModal/_createTeamModal.html';
import editRunForm from '../EditRunModal/_editRunForm.html';
import confirmationModal from '../ConfirmationModal/_confirmationModal.html';
...
(function() {
    ...
    function UserProfileModalController($filter, $localStorage, $q, $scope, Flash, MilesBoardApi, MilesBoardImages, 
        ...
        function onInit() {
            vm.newMemberForm = newMemberForm;
            vm.createTeamFrom = createTeamFrom;
            vm.editRunForm = editRunForm;
